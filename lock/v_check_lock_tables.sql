...
select tab1.tablename lock_table,tab1.lockmode wait_lockmode,tab1.usename wait_user,tab1.pid wait_procpid,tab1.query_start wait_start,
       ...
       tab2.query_start run_start,now()-tab2.query_start run_time,tab2.current_query run_sql
from (
select locktype,relation::regclass as tablename,pid,mode as lockmode,usename,bbb.query_start,substr(bbb.current_query,1,100) as current_query
from pg_locks aaa
